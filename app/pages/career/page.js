    ...
    <div className={page.root}>
      <div className={styles.top}>
        ...
        <div className={styles.ppl} ref={scene}>
          <div data-depth="0.3" className={styles.l} />
          <div data-depth="0.4" className={styles.r} />
        </div>
      ...
      <section className={classNames(page.section, styles.vacancies)}>
        ...
        <div className={styles.vacancy}>
          ...
          <p>
            Для начала разговора напишите на почту <a href="mailto:info@irinarain.com">info@irinarain.com</a> о себе и своем опыте работы.
